...
const useGetCurrentUserPlaylists = ({ limit, offset }: GetCurrentUserPlaylistRequest): UseInfiniteQueryResult<InfiniteData<GetCurrentUserPlaylistResponse, unknown>, Error> => {
